...
SOURCE_IMAGE = os.getenv("SOURCE_IMAGE", default='ghcr.io/dbha/tap/supply-chain/tanzu-java-web-app')
LOCAL_PATH = os.getenv("LOCAL_PATH", default='.')
NAMESPACE = os.getenv("NAMESPACE", default='demo')

custom_build('ghcr.io/dbha/tap/supply-chain/tanzu-java-web-app',
...
tanzu_k8s_yaml('tanzu-java-web-app', 'ghcr.io/dbha/tap/supply-chain/tanzu-java-web-app', './config/workload.yaml')
